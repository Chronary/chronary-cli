...
func TestICalListCommand(t *testing.T) {
	...
	rootCmd.SetArgs([]string{"ical", "list", "--agent", "agt_1", "--api-key", "chr_sk_xxx", "--base-url", srv.URL, "--output", "json"})
	require.NoError(t, rootCmd.Execute())
}

func TestICalListRequiresAgent(t *testing.T) {
	rootCmd := NewRootCmd("test")
	rootCmd.SetArgs([]string{"ical", "list", "--api-key", "chr_sk_xxx"})
...
func TestICalGetCommand(t *testing.T) {
	...
	rootCmd := NewRootCmd("test")
	rootCmd.SetArgs([]string{"ical", "get", "ics_1", "--api-key", "chr_sk_xxx", "--base-url", srv.URL, "--output", "json"})
	require.NoError(t, rootCmd.Execute())
}
...
func TestICalUpdateCommand(t *testing.T) {
	...
	rootCmd := NewRootCmd("test")
	rootCmd.SetArgs([]string{"ical", "update", "ics_1", "--label", "New Label", "--api-key", "chr_sk_xxx", "--base-url", srv.URL, "--output", "json"})
	require.NoError(t, rootCmd.Execute())
}
...
func TestICalDeleteCommand(t *testing.T) {
	...
	rootCmd := NewRootCmd("test")
	rootCmd.SetArgs([]string{"ical", "delete", "ics_1", "--force", "--api-key", "chr_sk_xxx", "--base-url", srv.URL})
	require.NoError(t, rootCmd.Execute())
}
...
func TestICalSyncCommand(t *testing.T) {
	...
	rootCmd := NewRootCmd("test")
	rootCmd.SetArgs([]string{"ical", "sync", "ics_1", "--api-key", "chr_sk_xxx", "--base-url", srv.URL})
	require.NoError(t, rootCmd.Execute())
}
